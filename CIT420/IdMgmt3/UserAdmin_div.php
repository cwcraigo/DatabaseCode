...
<html>
<! UserAdmin.php                                              >
<! OTN PHP Identity Management, Part 2                        >
...
<head>
<title>
  Identity Management, Part 2 - UserAdmin.php
</title>
<style type="text/css">
  div#centered {border:4px ridge silver;height:375px;top:10%;left:10%;width:400px;position:absolute;}
</style>
<link href="global.css" rel="stylesheet" type="text/css" />
</head>
<body class="stonehenge">
<?php
  // Start session.
  session_start();
  ...
  */
  ...
  function userAdminForm($args)
  {
    ...
    if ($_SESSION['db_error'] == DATABASE_VALID)
    {
      ...
      $out .= '<div class="titleBanner">';
      $out .= '<div class="italicExtraLarge">New User</div>';
      $out .= '</div>';

      // Check for and display error message.
      if ((isset($code)) && (is_int($code)))
        $out .= '<div class="messageMedium">'.get_message($code,$userid).'</div>';

      $out .= '<div class="entryArea">';
      $out .= '<form method="post" action="'.$form.'">';

      // Enable or disable text entry fields.
      if ((!@$_SESSION['client_info']) && (@$_SESSION['client_info'] == 0))
      {
        $out .= '<div class="formLeftMedium">User ID:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="newuserid" name="newuserid" type="text">';
        $out .= '</div>';
        $out .= '<div class="formLeftMedium">User Password:</div>';
        $out .= '<div  class="formRightMedium">';
        $out .= '<input id="newpasswd" name="newpasswd" type="password">';
        $out .= '</div>';
        $out .= '<div class="formLeftMedium">First Name:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="fname" name="fname" type="text">';
        $out .= '</div>';
        $out .= '<div class="formLeftMedium">First Name:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="lname" class="normal" name="lname" type="text">';
        $out .= '</div>';
        $out .= '</div>';
      }
      else
      {
        $out .= '<div class="formLeftMedium">User ID:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="d_newuserid" name="newuserid" type="text">';
        $out .= '</div>';
        $out .= '<br />';
        $out .= '<div class="formLeftMedium">User Password:</div>';
        $out .= '<div  class="formRightMedium">';
        $out .= '<input id="d_newpasswd" name="newpasswd" type="password">';
        $out .= '</div>';
        $out .= '<br />';
        $out .= '<div class="formLeftMedium">First Name:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="d_fname" name="fname" type="text">';
        $out .= '</div>';
        $out .= '<br />';
        $out .= '<div class="formLeftMedium">First Name:</div>';
        $out .= '<div class="formRightMedium">';
        $out .= '<input id="d_lname" class="normal" name="lname" type="text">';
        $out .= '</div>';
        $out .= '<br />';
      }

      $out .= '<div class="radioBanner">';

      // Enable or disable controls.
      if ((!@$_SESSION['client_info']) && (@$_SESSION['client_info'] == 0))
      {
        $out .= '<div class="radioLeftMedium">';
        $out .= '<input type="radio" name="usergroup" value="0" checked onClick="changeGroup(0);">Administration Group';
        $out .= '</div>';
        $out .= '<div class="radioRightMedium">';
      ...
      $out .= '</div></div>';
      $out .= '<div class="buttonBanner">';

      $out .= '<div class="buttonLeftMedium">';
      $out .= '<form method="post" action="'.$form.'">';
      if ((!@$_SESSION['client_info']) && (@$_SESSION['client_info'] == 0))
  ...
  function signOnUserAdmin()
  {
    if ($_SESSION['db_error'] == DATABASE_VALID)
    {
      ...
      $out .= '<input name="login" type="submit" value="Login">';
      $out .= '</td>';
      $out .= '</tr>';
      $out .= '</table>';
      $out .= '</td></tr>';
