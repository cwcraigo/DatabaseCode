  ...
  */
  ...
  function create_new_db_user($userid,$nuserid,$npasswd,$fname,$lname,$ugroup)
  {
    ...
    if ($c = @oci_connect(SCHEMA,PASSWD,TNS_ID))
    {
      ...
      $s = oci_parse($c,"CALL create_new_db_user(:userid
                                                ,:nuserid
                                                ,:newpassword
                                                ,:fname
                                                ,:lname
      ...
      oci_bind_by_name($s,":userid",$nuserid);
      oci_bind_by_name($s,":nuserid",$newpassword);
      oci_bind_by_name($s,":newpassword",$fname);
      oci_bind_by_name($s,":fname",$lname);
      oci_bind_by_name($s,":lname",$ugroup);
      oci_bind_by_name($s,":ugroup",$userid);
      oci_bind_by_name($s,":client_info",$_SESSION['client_info']);
      oci_bind_by_name($s,":return_value",$return_value);
